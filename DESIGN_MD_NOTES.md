...
* Neither DESIGN.md nor https://www.designtokens.org/tr/2025.10/format/ seem to support calculated values like how we do our spacing scales. This leads to having to generate the token as the calculated value.
* Due to the calculated values and color limitations, this forces the DESIGN.md file to only have the end values which may be helpful for reference but won't allow tools to write correct CSS by referencing this.
