...
`},u=(e,t,n)=>[e?`op-flank`:``,e&&t?`op-flank--end`:``,n?`gap-${n}`:``].filter(Boolean).join(` `)})),f=e({AvatarExample:()=>_,AvatarExampleEnd:()=>v,FlankEnd:()=>g,With:()=>m,Without:()=>h,__namedExportsOrder:()=>y,default:()=>p}),p,m,h,g,_,v,y,b=t((()=>{d(),p={title:`Utilities/Advanced/Flank`,render:({flank:e,end:t,...n})=>c({flank:e,end:t,...n}),argTypes:{flank:{control:`boolean`},end:{control:`boolean`},gap:{control:{type:`select`},options:[`none`,`xxs`,`xs`,`sm`,`md`,`lg`,`xl`]},example:{control:`boolean`}},parameters:{layout:`fullscreen`}},m={args:{flank:!0}},h={args:{flank:!1}},g={args:{flank:!0,end:!0}},_={args:{flank:!0,example:!0}},v={args:{flank:!0,example:!0,end:!0}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    flank: true
  }
