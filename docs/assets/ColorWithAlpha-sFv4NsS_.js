import{j as o,M as i}from"./index-CCw2sMFK.js";import{useMDXComponents as t}from"./index-Cp82c81x.js";import"./index-Dh2ko8Tu.js";import{c as n}from"./Alert-CAEs4394.js";import"./iframe-Bg2t51us.js";import"./index-BiL3ubqk.js";import"./index-DrFu-skq.js";import"./Button-B21kpIpO.js";import"./Icon-uqCTS4Mm.js";function r(a){const e={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...t(),...a.components};return o.jsxs(o.Fragment,{children:[o.jsx(i,{title:"Tokens/Color/Color with Alpha"}),`
`,o.jsx(e.h1,{id:"color-with-alpha",children:"Color With Alpha"}),`
`,o.jsx("div",{dangerouslySetInnerHTML:{__html:n({title:"Caution",icon:"priority_high",description:"Using alpha will impact Accessibility and if misused can also impact performance. Use these suggestions with caution and verify the resulting colors pass Accessibility standards!",iconDocsClassFix:"sb-unstyled"}).outerHTML}}),`
...
`,o.jsx(e.pre,{children:o.jsx(e.code,{className:"language-css",children:`/*
...
`,o.jsx("div",{dangerouslySetInnerHTML:{__html:n({title:"Benefits of this approach",icon:"info",warningLevel:"info",description:`
...
`})})]})}function v(a={}){const{wrapper:e}={...t(),...a.components};return e?o.jsx(e,{...a,children:o.jsx(r,{...a})}):r(a)}export{v as default};
