import{c as x}from"./Icon-uqCTS4Mm.js";import{c as y}from"./Button-B21kpIpO.js";const D=({headerLabel:c="Header Label",marker:i="arrow_right",additionalHeaderContent:_="",flipHeaderAndMarker:k=!1,disableAnimation:S=!1,content:C="Something small enough to escape casual notice."})=>{const r=document.createElement("details");r.className="accordion",S&&(r.className+=" accordion--disable-animation");const e=document.createElement("summary"),s=document.createElement("span");s.className="accordion__label",s.innerHTML=c;const d=x({name:i});return d.className+=" accordion__marker",e.innerHTML=`
  ...
  `,r.innerHTML+=C,r.innerHTML+=`
`,r},h={title:"Content Components/Accordion",render:({option1:c,...i})=>D({option1:c,...i}),argTypes:{headerLabel:{control:"text"},marker:{control:"text"},additionalHeaderContent:{control:"text"},flipHeaderAndMarker:{control:"boolean"},disableAnimation:{control:"boolean"},content:{control:"text"}},parameters:{layout:"padded"}},n={args:{}},a={args:{flipHeaderAndMarker:!0}},o={args:{disableAnimation:!0}},t={args:{additionalHeaderContent:y({label:"Button"}).outerHTML}};var l,m,u;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {}
