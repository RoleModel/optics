import{b as m}from"./utils-X3ES1otS.js";const i=({size:n="md"})=>{const e=document.createElement("div");return e.className=`flex gap-${n}`,m(e,5),e},p={title:"Utilities/Gap",render:({size:n,...e})=>i({size:n,...e}),argTypes:{size:{control:{type:"select"},options:["xxs","xs","sm","md","lg","xl"]}}},r={args:{size:"xxs"}},s={args:{size:"xs"}},a={args:{size:"sm"}},o={args:{size:"md"}},t={args:{size:"lg"}},c={args:{size:"xl"}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'xxs'
  }
