import{c as E}from"./Alert-CAEs4394.js";const P={title:"Components/Alert",render:({title:z,...C})=>E({title:z,...C}),argTypes:{warningLevel:{control:{type:"select"},options:["warning","danger","info","notice"]},style:{control:{type:"select"},options:["outlined","muted","filled"]},title:{control:"text"},description:{control:"text"},icon:{control:"text"},dismissible:{control:"boolean"}}},e={args:{title:"Warning",description:"This is a warning alert",warningLevel:"warning",icon:"warning"}},n={args:{title:"Danger",description:"This is a danger alert",warningLevel:"danger",icon:"error"}},r={args:{title:"Info",description:"This is an info alert",warningLevel:"info",icon:"error"}},i={args:{title:"Notice",description:"This is a notice alert",warningLevel:"notice",icon:"task_alt"}},a={args:{title:"Warning",description:"This is a muted warning alert",warningLevel:"warning",style:"muted",icon:"volume_mute"}},s={args:{title:"Warning",description:"This is a filled warning alert",warningLevel:"warning",style:"filled",icon:"check_box_outline_blank"}},t={args:{title:"Warning",description:"This is a warning alert with no icon",warningLevel:"warning"}},o={args:{description:"This is a warning alert with no title",warningLevel:"warning",icon:"check_box_outline_blank"}},c={args:{description:"This is a warning alert with a close icon",warningLevel:"warning",icon:"check_box_outline_blank",dismissible:!0}};var l,g,d;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    title: 'Warning',
