import{j as e,M as d,C as o,a as c}from"./WithTooltip-SK46ZJ2J-D25rk-eE.js";import{useMDXComponents as a}from"./index-DW-nmGvp.js";import{B as l,D as i,P as h,W as p,a as g,I as m,N as f,b as j,c as x}from"./Badge.stories-DaOUrMOj.js";import{c as r}from"./Alert-CAEs4394.js";import{c as u}from"./sourceCodeLink-Chh3FteF.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CR1j2QAj.js";import"./Icon-uqCTS4Mm.js";import"./Button-B21kpIpO.js";function t(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...a(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:l}),`
`,e.jsx(n.h1,{id:"badge",children:"Badge"}),`
`,e.jsx("div",{dangerouslySetInnerHTML:{__html:u({link:"components/badge.css"}).outerHTML}}),`
`,e.jsxs(n.p,{children:["The Badge component is similar to the Tag component, however it has a different semantic purpose. Badge is intended to be used for notification and information where Tag is intended to be used for interaction and input. See ",e.jsx(n.a,{href:"?path=/docs/components-tag--docs",children:"Tag"})," for details on its usage."]}),`
...
`})})]})}function B(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{B as default};
