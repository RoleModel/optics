...
<div class='form-group form-group--inline'>
  ...
  `},f={title:"Components/Switch",render:({...a})=>S({...a}),argTypes:{label:{control:"text"},size:{control:{type:"select"},options:["small","large"]},disabled:{control:{type:"boolean"}}}},e={args:{}},s={args:{size:"small"}},r={args:{disabled:!0}};var o,l,c;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {}
