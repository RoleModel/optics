import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";var n,r=e((()=>{n=({padded:e=!1,condensed:t=!1,label:n,header:r=``,body:i=``,footer:a=``,shadow:o=`none`})=>{let s=document.createElement(`div`);return s.className=[`card`,e?`card--padded`:``,t?`card--condensed`:``,o===`none`?``:`card--shadow-${o}`].filter(Boolean).join(` `),!r&&!i&&!a&&(s.innerHTML=n),r&&(s.innerHTML+=`
