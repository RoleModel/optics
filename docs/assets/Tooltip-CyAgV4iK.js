import{j as t,M as r,C as e,a as d}from"./WithTooltip-SK46ZJ2J-D25rk-eE.js";import{useMDXComponents as a}from"./index-DW-nmGvp.js";import{T as c,D as i,a as p,R as h,B as x,L as m,b as u,I as j,c as f}from"./Tooltip.stories-B-t2LJXN.js";import{c as g}from"./sourceCodeLink-Chh3FteF.js";import{c as s}from"./Alert-CAEs4394.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CR1j2QAj.js";import"./Button-B21kpIpO.js";import"./Icon-uqCTS4Mm.js";function l(n){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...a(),...n.components};return t.jsxs(t.Fragment,{children:[t.jsx(r,{of:c}),`
`,t.jsx(o.h1,{id:"tooltip",children:"Tooltip"}),`
`,t.jsx("div",{dangerouslySetInnerHTML:{__html:g({link:"components/tooltip.css"}).outerHTML}}),`
...
`,t.jsxs(o.p,{children:["There are cases when you might want to put a tooltip on a disabled ",t.jsx(o.a,{href:"?path=/docs/components-button--docs",children:"Button"}),`. Unfortunately due to the implementation of button which prioritizes simpler and easier to customize code, the hover is blocked which causes the tooltip to not show up.
...
`})})]})}function M(n={}){const{wrapper:o}={...a(),...n.components};return o?t.jsx(o,{...n,children:t.jsx(l,{...n})}):l(n)}export{M as default};
