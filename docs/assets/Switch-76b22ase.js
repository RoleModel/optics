import{j as e,M as c,C as i,a}from"./WithTooltip-SK46ZJ2J-D25rk-eE.js";import{useMDXComponents as l}from"./index-DW-nmGvp.js";import{S as h,D as n,a as d,b as p}from"./Switch.stories-CxlGT-_8.js";import{c as m}from"./sourceCodeLink-Chh3FteF.js";import{c as o}from"./Alert-CAEs4394.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CR1j2QAj.js";import"./Button-B21kpIpO.js";import"./Icon-uqCTS4Mm.js";function r(t){const s={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...l(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{of:h}),`
...
`,e.jsx(s.p,{children:"This is just a styling pattern that builds on standard checkbox inputs. Your project may need some tooling to generate this easily."}),`
`,e.jsxs(s.p,{children:["A commonly used tool for Ruby on Rails projects is ",e.jsx(s.a,{href:"https://github.com/heartcombo/simple_form",rel:"nofollow",children:"SimpleForm"}),". It allows you to build forms with pre-made inputs and allows you to make custom input types."]}),`
...
`})})]})}function S(t={}){const{wrapper:s}={...l(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(r,{...t})}):r(t)}export{S as default};
