import{c as o}from"./Button-u0TojoPW.js";import{c as m}from"./Icon-B5xiNJgP.js";const u=({warningLevel:s="warning",style:l="outlined",title:a="",description:c="This is a warning alert",icon:r="",dismissible:d=!1,iconDocsClassFix:i=""})=>{const e=document.createElement("div");if(e.className=["alert",`alert--${s}`,`alert--${l}`].join(" "),r){const t=m({name:r});t.classList.add("alert__icon"),i&&t.classList.add(i),e.innerHTML+=`
