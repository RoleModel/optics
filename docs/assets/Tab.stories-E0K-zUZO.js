const m=({size:o="large",activeTab:s="USA",disabledTab:l="Canada"})=>{const n=document.createElement("div");n.className="tab-group";const c=a=>{const e=document.createElement("a");return e.href="/?path=/docs/components-tab--docs",e.className=["tab",o==="small"?"tab--small":"",s===a?" tab--active":"",l===a?" tab--disabled":""].filter(Boolean).join(" "),e.innerText=a,l===a&&e.setAttribute("tabindex",-1),e},i=["USA","Mexico","Canada","England","Germany","Spain","Austria","Australia"];return n.innerHTML+=`
