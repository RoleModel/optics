import{j as e}from"./jsx-runtime-Ce5xs4Wy.js";import{u as c}from"./index-CPcV2wD4.js";import{M as l,C as s,d}from"./index-C52FNCyE.js";import{I as r,D as i,F as a,L as h,B as m,E as p}from"./Icon.stories-mrlEgeiF.js";import{c as x}from"./sourceCodeLink-Chh3FteF.js";import"./iframe-BN7FcqzY.js";import"../sb-preview/runtime.js";import"./index-B5rfWaSj.js";import"./index-DrFu-skq.js";import"./Icon-D9QrNi_D.js";function t(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...c(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:r}),`
`,e.jsx(n.h1,{id:"icon",children:"Icon"}),`
`,e.jsx("div",{dangerouslySetInnerHTML:{__html:x({link:"components/icon.scss"}).outerHTML}}),`
...
`,e.jsxs(n.p,{children:["To use an icon, put an element (usually a ",e.jsx(n.code,{children:"span"}),") with the class of ",e.jsx(n.code,{children:".material-symbols-outlined"})," and inner text of whatever icon you which to use I.E. ",e.jsx(n.code,{children:"settings"})," onto the page."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<span class="material-symbols-outlined">settings</span>
`})}),`
`,e.jsx(s,{of:i}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:".icon--medium"}),", ",e.jsx(n.code,{children:".icon--large"}),", ",e.jsx(n.code,{children:".icon--x-large"})," (with medium being the default) modify the size of any icon."]}),`
`,e.jsx(s,{of:h}),`
...
`,e.jsx(s,{of:p})]})}function C(o={}){const{wrapper:n}={...c(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{C as default};
