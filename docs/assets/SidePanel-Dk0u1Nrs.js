import{c as m}from"./Divider-DXVOsIdn.js";const d=(i,s,r,o=0,c="",l=!1)=>{const e=document.createElement("div");if(e.className=`side-panel__${i}`,s!=="none"){const a=s==="all"?"":`-${s}`;e.className+=` side-panel__${i}--padded${a}`}if(o>0){for(let a=0;a<o;a++){const t=d("section",c,"This is a section");e.innerHTML+=`
