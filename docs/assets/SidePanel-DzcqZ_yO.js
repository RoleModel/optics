import{i as e}from"./preload-helper-xPQekRTU.js";import{n as t,t as n}from"./Divider-BlC44GC6.js";var r,i,a=e((()=>{t(),r=(e,t,i,a=0,o=``,s=!1)=>{let c=document.createElement(`div`);if(c.className=`side-panel__${e}`,t!==`none`){let n=t===`all`?``:`-${t}`;c.className+=` side-panel__${e}--padded${n}`}if(a>0){for(let e=0;e<a;e++){let e=r(`section`,o,`This is a section`);c.innerHTML+=`
