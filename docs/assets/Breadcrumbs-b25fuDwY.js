import{j as e,M as c,C as n,a as d}from"./WithTooltip-SK46ZJ2J-D25rk-eE.js";import{useMDXComponents as i}from"./index-DW-nmGvp.js";import{B as l,D as o,L as h,S as m}from"./Breadcrumbs.stories-D1pXT9kU.js";import{c as p}from"./sourceCodeLink-Chh3FteF.js";import{c as t}from"./Alert-CAEs4394.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CR1j2QAj.js";import"./Icon-uqCTS4Mm.js";import"./Button-B21kpIpO.js";function a(r){const s={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{of:l}),`
...
`,e.jsxs(s.p,{children:[e.jsx(s.code,{children:".breadcrumbs__separator"})," is used to separate the links in the breadcrumbs. It is a div that anything can be put within, however typically would be used with an ",e.jsx(s.a,{href:"?path=/docs/components-icon--docs",children:"Icon"}),"."]}),`
`,e.jsx(n,{of:m}),`
...
`})})]})}function _(r={}){const{wrapper:s}={...i(),...r.components};return s?e.jsx(s,{...r,children:e.jsx(a,{...r})}):a(r)}export{_ as default};
