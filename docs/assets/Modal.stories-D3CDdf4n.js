import{a as e,i as t}from"./preload-helper-xPQekRTU.js";var n,r,i=t((()=>{n=({header:e,body:t,footer:n=``,inlineDemo:i=!1,dialog:a=!1})=>{if(a)return r({header:e,body:t,footer:n});let o=document.createElement(`div`);return o.classList=`modal-wrapper modal-wrapper--active ${i?`modal-wrapper--demo`:``}`,o.innerHTML=`
