const c=a=>`
<nav class="sidebar-domains sidebar--padded sidebar--${a}">
...
`,b=a=>`
<nav class="sidebar-16six sidebar--padded sidebar--${a}">
  <a class="sidebar__brand" href="/">
...
`,p=({example:a="domains",style:n="drawer"})=>`
...
`,m={title:"Recipes/Custom Sidebar",render:({...a})=>p({...a}),argTypes:{example:{control:{type:"select"},options:["domains","16six"]},style:{control:{type:"select"},options:["drawer","rail"]}},parameters:{layout:"fullscreen"}},s={args:{example:"domains",style:"drawer"}},e={args:{example:"16six",style:"drawer"}};var r,t,o;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    example: 'domains',
    style: 'drawer'
  }
}`,...(o=(t=s.parameters)==null?void 0:t.docs)==null?void 0:o.source}}};var i,l,d;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    example: '16six',
    style: 'drawer'
  }
