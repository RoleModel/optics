import{j as e}from"./jsx-runtime-Ce5xs4Wy.js";import{u as r}from"./index-CPcV2wD4.js";import{M as i,C as t,d}from"./index-C52FNCyE.js";import{T as c,D as o,P as h,a as p,F as x,C as b,b as m,S as j,c as u,d as f,e as g,f as y,g as v}from"./Table.stories-CYIxHYll.js";import{c as w}from"./sourceCodeLink-Chh3FteF.js";import{c as s}from"./Alert-93ao7bSE.js";import"./iframe-BN7FcqzY.js";import"../sb-preview/runtime.js";import"./index-B5rfWaSj.js";import"./index-DrFu-skq.js";import"./Pagination-DmuckP5n.js";import"./Button-CoyIamir.js";import"./Icon-D9QrNi_D.js";function l(a){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...r(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:c}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:".table-primary"})," Provides a table with a primary colored header."]}),`
`,e.jsx(t,{of:h}),`
`,e.jsx(n.h3,{id:"danger",children:"Danger"}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:".table-danger"})," Provides a table with a danger colored header."]}),`
`,e.jsx(t,{of:p}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:".table--even-striped"}),", ",e.jsx(n.code,{children:".table--odd-striped"})," color every (odd or even) other row with a light color. The color matches the default, primary, or danger."]}),`
`,e.jsx(t,{of:j}),`
`,e.jsx(t,{of:u}),`
...
`})})]})}function F(a={}){const{wrapper:n}={...r(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(l,{...a})}):l(a)}export{F as default};
