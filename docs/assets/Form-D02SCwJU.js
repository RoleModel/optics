import{j as e,M as h,C as n,a as s}from"./blocks-BPxk_-54.js";import{useMDXComponents as a}from"./index-CyN62Cw9.js";import{Default as i}from"./ErrorSummary.stories-BNbhrYk7.js";import{Default as t,Inline as m,Radio as p,Checkbox as x,Error as f,Hint as j,NoBorder as u,Small as y,Readonly as b,IndeterminateCheckbox as g}from"./FormGroup.stories-D81w02di.js";import{Default as v,Color as w}from"./Input.stories-BpXnVkXQ.js";import{Default as k}from"./Label.stories-BS40R5oG.js";import{Default as l}from"./Select.stories-C2CjJz_S.js";import{Default as c}from"./Textarea.stories-CDxRQzoE.js";import{c as C}from"./sourceCodeLink-Chh3FteF.js";import{c as T}from"./Alert-CAEs4394.js";import"./preload-helper-C1FmrZbK.js";import"./iframe-D28E1yIw.js";import"./Form-DW9OsOtr.js";import"./Button-B21kpIpO.js";import"./Icon-uqCTS4Mm.js";function d(r){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...a(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Components/Form"}),`
`,e.jsx(o.h1,{id:"form",children:"Form"}),`
`,e.jsx("div",{dangerouslySetInnerHTML:{__html:C({link:"components/form.css"}).outerHTML}}),`
...
`,e.jsxs(o.p,{children:[e.jsx(o.code,{children:".form-group.form-group--error"})," and ",e.jsx(o.code,{children:".form-error"})," are typically used on combination when there is a validation error on an input. They highlight the input in error along with the message provided."]}),`
`,e.jsx(n,{of:f}),`
...
`,e.jsxs(o.p,{children:[e.jsx(o.code,{children:".form-control.form-control--no-border"})," can be used to create a borderless input or select. When used in a form group with ",e.jsx(o.code,{children:".form-control.form-group--error"}),", the input will get a red bottom border and highlight."]}),`
`,e.jsx(n,{of:u}),`
`,e.jsx(o.h3,{id:"size",children:"Size"}),`
`,e.jsxs(o.p,{children:[e.jsx(o.code,{children:".form.form-control--small"}),", ",e.jsx(o.code,{children:".form.form-control--medium"}),", ",e.jsx(o.code,{children:".form.form-control--large"})," (with large being the default) modify the size of any element by changing the font and height to be smaller or larger."]}),`
`,e.jsx(n,{of:y}),`
...
`,`
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-css",children:`/* .form-control */
...
`,e.jsxs(o.p,{children:["The form classes are structured using the ",e.jsx(o.a,{href:"https://getbem.com/naming",rel:"nofollow",children:"BEM methodology"}),"."]}),`
...
`,e.jsxs(o.p,{children:[e.jsx(o.code,{children:".form-control"})," is the placeholder selector that is used to style all form controls."]}),`
`,e.jsxs(o.p,{children:[e.jsx(o.code,{children:".form-control:not([type='radio'], [type='checkbox'])"})," is the selector that is used to style form controls based on the input like color, date, text, number, etc."]}),`
`,e.jsxs(o.p,{children:[e.jsx(o.code,{children:".form-control:is([type='radio'], [type='checkbox'])"})," is the selector that is used to style checkboxes and radio buttons."]}),`
`,e.jsx(o.p,{children:"You can open them up like so to modify the styles:"}),`
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-css",children:`.form-control {
}
`})})]})}function G(r={}){const{wrapper:o}={...a(),...r.components};return o?e.jsx(o,{...r,children:e.jsx(d,{...r})}):d(r)}export{G as default};
