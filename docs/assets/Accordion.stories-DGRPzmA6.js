import{c as x}from"./Icon-B5xiNJgP.js";import{c as y}from"./Button-u0TojoPW.js";const D=({headerLabel:c="Header Label",marker:i="arrow_right",additionalHeaderContent:_="",flipHeaderAndMarker:k=!1,disableAnimation:S=!1,content:C="Something small enough to escape casual notice."})=>{const r=document.createElement("details");r.className="accordion",S&&(r.className+=" accordion--disable-animation");const e=document.createElement("summary"),s=document.createElement("span");s.className="accordion__label",s.innerHTML=c;const d=x({name:i});return d.className+=" accordion__marker",e.innerHTML=`
