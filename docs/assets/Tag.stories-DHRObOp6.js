import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./Button-BUsOhhs6.js";var i,a=t((()=>{n(),i=({label:e,type:t=`readonly`,iconLeft:n=!1,iconRight:i=!1})=>{let a=document.createElement(`div`),o=document.createElement(`span`);return o.innerText=e,o.className=`tag__label`,a.append(o),n&&a.prepend(r({variant:`default`,noBorder:!0,icon:`close`,pill:!0})),i&&a.append(r({variant:`default`,noBorder:!0,icon:`close`,pill:!0})),a.className=[`tag`,`tag--${t}`].filter(Boolean).join(` `),a}})),o=e({Danger:()=>u,Info:()=>f,Notice:()=>p,Primary:()=>l,Readonly:()=>c,Warning:()=>d,__namedExportsOrder:()=>m,default:()=>s}),s,c,l,u,d,f,p,m,h=t((()=>{a(),s={title:`Components/Tag`,render:({label:e,...t})=>i({label:e,...t}),argTypes:{label:{control:`text`},type:{control:{type:`select`},options:[`readonly`,`primary`,`danger`,`warning`,`info`,`notice`]},iconLeft:{control:`boolean`},iconRight:{control:`boolean`}}},c={args:{label:`Readonly`,type:`readonly`}},l={args:{label:`Primary`,type:`primary`}},u={args:{label:`Danger`,type:`danger`}},d={args:{label:`Warning`,type:`warning`}},f={args:{label:`Info`,type:`info`}},p={args:{label:`Notice`,type:`notice`}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Readonly',
    type: 'readonly'
  }
