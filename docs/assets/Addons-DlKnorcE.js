import{j as e,M as n}from"./blocks-D2pTyHFk.js";import{useMDXComponents as t}from"./index-Cur9J7FO.js";import{c as l}from"./sourceCodeLink-Chh3FteF.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-qQGGZl47.js";function i(s){const o={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n,{title:"Overview/Addons"}),`
...
`]}),`
`,e.jsxs(o.p,{children:[`These can be imported alongside the base design system to provide additional icon options. They can also be integrated with the base design system instead of as an addon if you don't want to use the default Material Symbols Outlined icons. This will reduce the page load time by not loading the Material Symbols Outlined icons.
Note: This alternate import approach (optics+icon_library) supports the minified versions as well. Just add `,e.jsx(o.code,{children:".min.css"})," to the end of the file name."]}),`
...
`,e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-css",children:`/* Full Material Symbols Outlined Package */
...
`})})]})}function p(s={}){const{wrapper:o}={...t(),...s.components};return o?e.jsx(o,{...s,children:e.jsx(i,{...s})}):i(s)}export{p as default};
