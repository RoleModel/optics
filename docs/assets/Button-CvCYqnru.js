import{j as e}from"./jsx-runtime-Ce5xs4Wy.js";import{u as a}from"./index-CPcV2wD4.js";import{M as d,C as o,d as l}from"./index-C52FNCyE.js";import{B as c,D as s,P as h,a as b,A as u,N as p,b as m,c as x,I as j,d as g,S as f}from"./Button.stories-DlGJpKRG.js";import{c as v}from"./sourceCodeLink-Chh3FteF.js";import{c as r}from"./Alert-93ao7bSE.js";import"./iframe-BN7FcqzY.js";import"../sb-preview/runtime.js";import"./index-B5rfWaSj.js";import"./index-DrFu-skq.js";import"./Button-CoyIamir.js";import"./Icon-D9QrNi_D.js";function i(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:c}),`
`,e.jsx(n.h1,{id:"button",children:"Button"}),`
`,e.jsx("div",{dangerouslySetInnerHTML:{__html:v({link:"components/button.scss"}).outerHTML}}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:".btn--no-border"})," This is a modifier which can be used with all button classes except destructive. It provides a button with no border, but the same sizing and adapts it's color to all the btn variations."]}),`
`,e.jsxs(n.p,{children:["Note: ",e.jsx(n.code,{children:".btn-destructive"})," and ",e.jsx(n.code,{children:".btn-warning"})," do not support the ",e.jsx(n.code,{children:".btn--no-border"})," modifier. Borderless warning or destructive buttons is not considered a good pattern and can easily lead to confusion so it has been disabled."]}),`
`,e.jsx(o,{of:p}),`
...
`,e.jsx(n.p,{children:`All button classes, regardless of the currently applied size modifier, will automatically adjust to the large button size on mobile screens ($breakpoint-small ~ 768px).
...
`,e.jsx("div",{dangerouslySetInnerHTML:{__html:r({title:"Important!",description:"These patterns represent how to customize the style of the button for your project."}).outerHTML}}),`
`,e.jsxs(n.p,{children:["The button classes are built on a ",e.jsx(n.a,{href:"https://sass-lang.com/documentation/style-rules/placeholder-selectors",rel:"nofollow",children:"sass placeholder selector"})]}),`
`,e.jsxs(n.p,{children:["This allows multiple button classes to share the same behavior. You can modify all buttons behavior by overriding the ",e.jsx(n.code,{children:"%btn-global"})," placeholder selector and setting any properties:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-css",children:`%btn-global {
  border-radius: 0;
}
`})}),`
...
`,e.jsx("div",{dangerouslySetInnerHTML:{__html:r({title:"Important!",description:"These patterns represent how to create new variations of the button for your project."}).outerHTML}}),`
`,e.jsx(n.p,{children:"Your application may need a custom button. To add one, just follow this template:"}),`
