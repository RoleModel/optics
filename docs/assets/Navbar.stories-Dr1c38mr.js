import{c as j}from"./Navbar-BTsgfUvv.js";const _={title:"Navigation Components/Navbar",render:({...S})=>j({...S}),argTypes:{style:{control:{type:"select"},options:["default","primary"]},brand:{control:"boolean"},justify:{control:{type:"select"},options:["start","center","end"]},activeLink:{control:{type:"select"},options:["Inbox","Outbox","Favorite","Something"]}},parameters:{layout:"fullscreen"}},e={args:{style:"default"}},r={args:{style:"primary"}},a={args:{size:"drawer",style:"default",brand:!1}},s={args:{style:"default",justify:"center"}},t={args:{style:"default",justify:"end"}};var o,n,c;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    style: 'default'
  }
