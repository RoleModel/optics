import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{n,t as r}from"./Icon-CRcwQQX1.js";import{n as i,t as a}from"./Button-BDOseHCb.js";var o,s=e((()=>{n(),o=({headerLabel:e=`Header Label`,marker:t=`arrow_right`,additionalHeaderContent:n=``,flipHeaderAndMarker:i=!1,disableAnimation:a=!1,content:o=`Something small enough to escape casual notice.`})=>{let s=document.createElement(`details`);s.className=`accordion`,a&&(s.className+=` accordion--disable-animation`);let c=document.createElement(`summary`),l=document.createElement(`span`);l.className=`accordion__label`,l.innerHTML=e;let u=r({name:t});return u.className+=` accordion__marker`,c.innerHTML=`
