import{j as e,M as l,C as o,a as c}from"./WithTooltip-SK46ZJ2J-D25rk-eE.js";import{useMDXComponents as r}from"./index-DW-nmGvp.js";import{P as d,D as s,W as h}from"./Pagination.stories-B35yiimK.js";import{c as p}from"./sourceCodeLink-Chh3FteF.js";import{c as i}from"./Alert-CAEs4394.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-CR1j2QAj.js";import"./Pagination-CeSb3t6J.js";import"./Button-B21kpIpO.js";import"./Icon-uqCTS4Mm.js";function a(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:d}),`
`,e.jsx(n.h1,{id:"pagination",children:"Pagination"}),`
`,e.jsx("div",{dangerouslySetInnerHTML:{__html:p({link:"components/pagination.css"}).outerHTML}}),`
...
`,e.jsxs(n.p,{children:["An example of using this component with the Table component can be found in ",e.jsx(n.a,{href:"?path=/docs/components-table--docs#with-pagination",children:"Table With Pagination"}),"."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:".pagination"})," Is the main class. It can be placed on a ",e.jsx(n.code,{children:"nav"})," element and wraps a collection of ",e.jsx(n.a,{href:"?path=/docs/components-button--docs",children:"buttons"})," to create a pagination component."]}),`
...
`,e.jsxs(n.p,{children:["The pagination classes are structured using the ",e.jsx(n.a,{href:"https://getbem.com/naming",rel:"nofollow",children:"BEM methodology"}),"."]}),`
`,e.jsxs(n.p,{children:["This allows us to define core styles on a main ",e.jsx(n.a,{href:"https://getbem.com/naming/#block",rel:"nofollow",children:"block"})," class, and use ",e.jsx(n.a,{href:"https://getbem.com/naming/#modifier",rel:"nofollow",children:"modifiers"})," to encapsulate variant styles. You can modify all pagination behavior by overriding the ",e.jsx(n.code,{children:"%pagination-global"})," selector and setting any properties:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-css",children:`.pagination {
}
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-css",children:`.pagination--{name} {
}
`})})]})}function T(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{T as default};
