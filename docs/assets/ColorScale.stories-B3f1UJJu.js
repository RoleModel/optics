import{p as a,c as s,a as u,s as b}from"./utils-X3ES1otS.js";const $=({scale:e="primary",step:r="base"})=>{const i=document.createElement("div"),d=`var(--op-color-${a(e)}-${a(r)})`,m=`var(--op-color-${a(e)}-on-${a(r)})`,g=`var(--op-color-${a(e)}-on-${a(r)}-alt)`;return i.style.backgroundColor=d,i.classList="card-padded",i.innerHTML=`
