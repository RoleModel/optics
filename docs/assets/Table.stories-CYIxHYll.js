import{c as nt}from"./Pagination-DmuckP5n.js";const dt=({style:h="default",layout:et="auto",density:rt="default",striped:b="off",sticky:y="off",height:ot=!1,checkbox:t=!1,paginationInFooter:at=!1})=>{const m=document.createElement("div");m.className="table-container";const g=document.createElement("table");let f="";y!=="off"&&(f=`table--sticky-${y}`),y==="both"&&(f="table--sticky-header table--sticky-footer"),g.className=[h==="default"?"table":`table-${h}`,`table--${et}-layout`,`table--${rt}-density`,b==="off"?"":`table--${b}-striped`,f].filter(Boolean).join(" ");const st=()=>at?`
      <tr>
        <td colspan="3">
