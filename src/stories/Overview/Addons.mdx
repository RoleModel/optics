...
Panel provide styles that is intended to accompany the rails configuration and javascript implemented by [RoleModel Rails Panel](https://github.com/RoleModel/rolemodel_rails/tree/master/lib/generators/rolemodel/modals) Similar to the Modal Component
