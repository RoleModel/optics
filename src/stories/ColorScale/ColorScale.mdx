...
Here is the full primary scale for reference.
...
[All Color Scales and their Definitions](https://github.com/RoleModel/optics/blob/main/src/core/tokens/scale_color_tokens.scss)

[All Dark Mode Overrides](https://github.com/RoleModel/optics/blob/main/src/core/tokens/dark_mode_tokens.scss)
