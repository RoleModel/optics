...
Optics provides two patterns for application layout. The basic (legacy) version is maintained for backwards compatibility, but we recommend using the `op-page` pattern for new projects.
...
<a href="/public/example-layout.html" target="_blank" rel="noopener noreferrer">
...
<a href="/public/spinner-layout.html" target="_blank" rel="noopener noreferrer">
  Click here to open the playground
</a>
...
<a href="/public/login-layout.html" target="_blank" rel="noopener noreferrer">
  Click here to open the playground
</a>
