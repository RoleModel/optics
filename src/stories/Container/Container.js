export const createContainer = ({ size = '', padding = '' }) => {
  ...
  page.style.backgroundColor = 'var(--rm-color-alerts-warning-base)'
  page.style.height = '30rem'

  const container = document.createElement('div')
  container.style.backgroundColor = 'var(--rm-color-alerts-notice-base)'
  ...
  innerContents.style.backgroundColor = 'var(--rm-color-primary-base)'
