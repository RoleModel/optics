...
# Welcome to Optics Design System

<h2>V{version}</h2>

Optics Design System by RoleModel Software is an scss package that provides base styles and components that can be integrated and customized in a variety of projects.
