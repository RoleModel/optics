...
<div
  dangerouslySetInnerHTML={{
    __html: createSourceCodeLink({ link: 'components/avatar.scss' }).outerHTML,
  }}
></div>
...
This allows us to define core styles on a main [block](https://getbem.com/naming/#block) class, and use [modifiers](https://getbem.com/naming/#modifier) to encapsulate variant styles. You can modify all avatar behavior by overriding the `.avatar` placeholder selector and setting any properties:
