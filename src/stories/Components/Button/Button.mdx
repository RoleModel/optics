...
This allows multiple button classes to share the same behavior. You can modify all buttons behavior by overriding the `%btn-global` selector and setting any properties:
