...
<div
  dangerouslySetInnerHTML={{
    __html: createAlert({
      ...
      icon: 'info',
      warningLevel: 'info',
      description: 'The wrapping div with a height in the code snippets is just for demonstration purposes in this documentation. It is not necessary for use in your application.',
...
.sidepanel-{name} {
  ...
  --_op-side-panel-width: calc(21 * var(--op-space-x-large));
