...
Use `.tag` to apply the default class.

<Canvas of={TagStories.Default} />

### Readonly

Use `.tag-readonly` to apply the readonly class.

<Canvas of={TagStories.Readonly} />

### Danger

Use `.tag-danger` to apply the danger class.

<Canvas of={TagStories.Danger} />

### Warning

Use `.tag-warning` to apply the warning class.

<Canvas of={TagStories.Warning} />

### Info

Use `.tag-info` to apply the info class.

<Canvas of={TagStories.Info} />

### Notice

Use `.tag-notice` to apply the notice class.
