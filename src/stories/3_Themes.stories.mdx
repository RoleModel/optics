...
This will ignore the system preference and use specified theme mode.
```html
<!DOCTYPE html>
...
If your application does not use or need dark mode, you can force it to always use light mode, or disable it with:
```html
<!DOCTYPE html>
...
Your application can have multiple predefined themes which can be switched between by setting a data attribute attribute on the root html element.
